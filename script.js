...
document.getElementById("generatePDFBtn").addEventListener("click", ()=>{
    ...
    doc.text(`Total Cost: ${document.getElementById("totalCost").textContent}`,450,finalY);
    doc.text(`GST Amount: ${document.getElementById("gstAmount").textContent}`,450,finalY+15);
    doc.text(`Final Cost: ${document.getElementById("finalCost").textContent}`,450,finalY+30);
    ...
    doc.text(paymentNote,40,finalY+65, {maxWidth:500});

    // 2D→3D images
    let yOffset = finalY+90;
