            ...
            if(value && inv[filterKey] && inv[filterKey].toLowerCase().includes(value.toLowerCase())){
                ...
                btn.addEventListener("click", ()=>{
                    ...
                    inv.designs.forEach(d=>{
                        const div=document.createElement("div");
                        div.className="design-item";
                        div.innerHTML=`<img src="${d.src}" class="design-thumb"><div class="design-info"><input class="design-name" value="${d.name}"><div class="design-controls"><button class="generate3DBtn">Generate 3D</button><button class="removeDesignBtn">Remove</button></div></div>`;
                        div.querySelector(".removeDesignBtn").addEventListener("click",()=>div.remove());
                        designList.appendChild(div);
                    });
                    recalcInvoice();
...
createRecoveryButton("searchByInvoiceNumber","searchInvoiceNumber","invoiceNumber");
createRecoveryButton("searchByClientName","searchClientName","clientName");
createRecoveryButton("searchByInvoiceDate","searchInvoiceDate","invoiceDate");
